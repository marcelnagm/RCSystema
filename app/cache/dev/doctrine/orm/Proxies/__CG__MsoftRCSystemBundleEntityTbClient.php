 ...
 */
class TbClient extends \Msoft\RCSystemBundle\Entity\TbClient implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'id', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'documentId', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'name', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'cellphone', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'address', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'email', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'dateIn', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'userIn', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'dateUpdated', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'userUpdated', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'removed', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbClient' . "\0" . 'userRemoved');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TbClient $proxy) {
