 ...
 */
class TbStock extends \Msoft\RCSystemBundle\Entity\TbStock implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbStock' . "\0" . 'quantity', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbStock' . "\0" . 'dateIn', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbStock' . "\0" . 'userIn', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbStock' . "\0" . 'dateUpdated', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbStock' . "\0" . 'userUpdated', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbStock' . "\0" . 'removed', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbStock' . "\0" . 'userRemoved', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbStock' . "\0" . 'id', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbStock' . "\0" . 'idProduct');
        }
