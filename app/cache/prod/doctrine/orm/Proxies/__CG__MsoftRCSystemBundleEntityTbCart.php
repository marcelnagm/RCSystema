 ...
 */
class TbCart extends \Msoft\RCSystemBundle\Entity\TbCart implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'quantity', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'dateIn', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'userIn', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'dateUpdated', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'userUpdated', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'removed', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'userRemoved', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'id', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'idShop', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbCart' . "\0" . 'idProduct');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TbCart $proxy) {
