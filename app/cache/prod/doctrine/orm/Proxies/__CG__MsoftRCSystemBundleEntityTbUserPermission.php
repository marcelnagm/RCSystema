 ...
 */
class TbUserPermission extends \Msoft\RCSystemBundle\Entity\TbUserPermission implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbUserPermission' . "\0" . 'module', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbUserPermission' . "\0" . 'permission', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbUserPermission' . "\0" . 'id', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbUserPermission' . "\0" . 'idUser');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TbUserPermission $proxy) {
