 ...
 */
class TbSubcategory extends \Msoft\RCSystemBundle\Entity\TbSubcategory implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbSubcategory' . "\0" . 'description', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbSubcategory' . "\0" . 'id', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbSubcategory' . "\0" . 'idCategory');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TbSubcategory $proxy) {
