 ...
 */
class CategoryAffiliate extends \Ens\JobeetBundle\Entity\CategoryAffiliate implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Ens\\JobeetBundle\\Entity\\CategoryAffiliate' . "\0" . 'id', '' . "\0" . 'Ens\\JobeetBundle\\Entity\\CategoryAffiliate' . "\0" . 'category', '' . "\0" . 'Ens\\JobeetBundle\\Entity\\CategoryAffiliate' . "\0" . 'affiliate');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (CategoryAffiliate $proxy) {
