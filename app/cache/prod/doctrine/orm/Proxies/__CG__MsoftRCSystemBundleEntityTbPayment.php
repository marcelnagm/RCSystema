 ...
 */
class TbPayment extends \Msoft\RCSystemBundle\Entity\TbPayment implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'value', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'dateIn', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'userIn', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'dateUpdated', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'userUpdated', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'removed', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'userRemoved', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'id', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'idShop', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'idClient', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbPayment' . "\0" . 'idMethod');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TbPayment $proxy) {
    ...
    public function setIdMethod(\Msoft\RCSystemBundle\Entity\TbMethodPayment $idMethod = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setIdMethod', array($idMethod));

        return parent::setIdMethod($idMethod);
    }
    ...
    public function getIdMethod()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getIdMethod', array());

        return parent::getIdMethod();
    }
