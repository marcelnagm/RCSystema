...
class TbShop extends \Msoft\RCSystemBundle\Entity\TbShop implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbShop' . "\0" . 'total', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbShop' . "\0" . 'pending', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbShop' . "\0" . 'id', '' . "\0" . 'Msoft\\RCSystemBundle\\Entity\\TbShop' . "\0" . 'idClient');
        }
